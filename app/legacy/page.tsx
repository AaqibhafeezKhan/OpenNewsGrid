...
export const metadata: Metadata = {
  ...
  description: 'View the original static HTML/CSS version of Global News Daily.',
};
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            The original static HTML/CSS version that started it all. 
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">
                  See the original static HTML/CSS version with placeholder content.
                </p>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">
                  View the source code on GitHub. The original static HTML/CSS project.
                </p>
                <span className="inline-flex items-center gap-1 text-primary text-sm font-medium">
                  View on GitHub
                  <ExternalLink className="h-4 w-4" />
